...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'poster'], function () {
        Route::get('get-posters', 'PosterController@get_posters');
    });

    // Delivery Location
    Route::group(['prefix' => 'delivery-check'], function () {
        Route::get('check-availabilty', 'CheckAvailabilityController@check');
    });

    // Delivery ticket status
    Route::group(['prefix' => 'delivery'], function () {
        Route::post('ticket-status', 'CheckAvailabilityController@update_ticket_status');
    });
