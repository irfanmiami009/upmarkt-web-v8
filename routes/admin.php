...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'news', 'as' => 'news.'], function () {
            ...
            Route::get('update/{id}', 'NewsController@edit')->name('update');
            Route::post('update/{id}', 'NewsController@update');
            Route::post('delete', 'NewsController@delete')->name('delete');
        });

        Route::group(['prefix' => 'delivery-location', 'as' => 'delivery-location.'], function () {
            Route::get('list', 'DeliveryLocationController@list')->name('list');
        });

        /* Handle Delivery */
        Route::group(['prefix' => 'handle-delivery', 'as' => 'handle-delivery.'], function () {
            Route::post('auth', 'HandleDeliveryController@auth')->name('auth');
            Route::put('create-ticket', 'HandleDeliveryController@create_ticket')->name('create-ticket');
            Route::get('cancel-ticket', 'HandleDeliveryController@cancel_ticket')->name('cancel-ticket');
            Route::get('update-ticket', 'HandleDeliveryController@update_ticket')->name('update-ticket');
        });
        ...
        Route::group(['prefix' => 'poster', 'as' => 'poster.','middleware'=>['module:marketing_section']], function () {
        ...
        Route::group(['prefix' => 'section', 'as' => 'section.','middleware'=>['module:marketing_section']], function () {
            Route::get('list', 'SectionController@list')->name('list');
            Route::post('status', 'SectionController@status')->name('status');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.','middleware'=>['module:business_settings']], function () {
            ...
            Route::post('return-policy', 'BusinessSettingsController@return_policy_update')->name('return-policy');
