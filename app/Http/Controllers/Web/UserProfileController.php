...
class UserProfileController extends Controller
{
    public function user_account(Request $request)
    {
        if (auth('customer')->check()) {
            ...
            return view('web-views.users-profile.account-profile', compact('customerDetail', 'categories'));
        } else {
    ...
    public function account_address()
    {
        if (auth('customer')->check()) {
            ...
            return view('web-views.users-profile.account-address', compact('shippingAddresses','categories'));
        } else {
            return redirect()->route('home');
        }
    }
    ...
    public function account_oder()
    {
        ...
        $categories = Category::where('position', 0)->priority()->take(12)->get();
        return view('web-views.users-profile.account-orders', compact('orders', 'categories'));
    }
    ...
    public function account_order_details(Request $request)
    {
        ...
        $categories = Category::where('position', 0)->priority()->take(12)->get();
        return view('web-views.users-profile.account-order-details', compact('order', 'categories'));
    }
    ...
    public function account_wishlist()
    {
        if (auth('customer')->check()) {
            ...
            $categories = Category::where('position', 0)->priority()->take(12)->get();
            return view('web-views.products.wishlist', compact('wishlists', 'categories'));
        } else {
            return redirect()->route('home');
        }
    }
    ...
    public function account_tickets()
    {
        if (auth('customer')->check()) {
            ...
            $categories = Category::where('position', 0)->priority()->take(12)->get();
            return view('web-views.users-profile.account-tickets', compact('supportTickets', 'categories'));
        } else {
            return redirect()->route('home');
        }
    }
    ...
    {
        $categories = Category::where('position', 0)->priority()->take(12)->get();
        return view('web-views.order-tracking-page', compact('categories'));
    }
    ...
    public function track_order_result(Request $request)
    {
        ...
        if (isset($orderDetails)){
            $track_list = BizlogOrder::where('order_id', $request['order_id'])->get();
            return view('web-views.order-tracking', compact('orderDetails', 'categories', 'track_list'));
        }
