...
class ChattingController extends Controller
{
    public function chat_with_seller(Request $request)
    {
        ...
        if (isset($last_chat)) {
            ...
            return view('web-views.users-profile.profile.chat-with-seller', compact('chattings', 'unique_shops', 'last_chat', 'categories'));
        }
        return view('web-views.users-profile.profile.chat-with-seller', compact('categories'));
