...
class WebController extends Controller
{
    ...
    public function home()
    {
        ...
        $section_brands =  Section::where(['section' => 'Brands', 'published' => 1])->first();
        $section_new_arrival = Section::where(['section' => 'New Arrival', 'published' => 1])->first();
        $section_news = Section::where(['section' => 'News', 'published' => 1])->first();
        $brands = Brand::take(15)->get();
        //cat1
        $section_cat_1 = Section::where(['section' => 'Categories 1', 'published' => 1])->first();
        $cat_1_1 = Poster::where(['poster_type' => 'Categories 1', 'published' => 1, 'display_orders' => 1])->first();
        $cat_1_2 = Poster::where(['poster_type' => 'Categories 1', 'published' => 1, 'display_orders' => 2])->first();
        $cat_1_3 = Poster::where(['poster_type' => 'Categories 1', 'published' => 1, 'display_orders' => 3])->first();
        $cat_1_4 = Poster::where(['poster_type' => 'Categories 1', 'published' => 1, 'display_orders' => 4])->first();

        // cat2
        $section_cat_2 = Section::where(['section' => 'Categories 2', 'published' => 1])->first();
        $cat_2_1 = Poster::where(['poster_type' => 'Categories 2', 'published' => 1, 'display_orders' => 1])->first();
        $cat_2_2 = Poster::where(['poster_type' => 'Categories 2', 'published' => 1, 'display_orders' => 2])->first();
        $cat_2_3 = Poster::where(['poster_type' => 'Categories 2', 'published' => 1, 'display_orders' => 3])->first();
        $cat_2_4 = Poster::where(['poster_type' => 'Categories 2', 'published' => 1, 'display_orders' => 4])->first();

        //$deals
        $section_deals = Section::where(['section' => 'Deals', 'published' => 1])->first();
        $deals_1 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 1])->first();
        $deals_2 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 2])->first();
        $deals_3 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 3])->first();
        $deals_4 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 4])->first();
        $deals_5 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 5])->first();
        $deals_6 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 6])->first();
        $deals_7 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 7])->first();
        $deals_8 = Poster::where(['poster_type' => 'Deals', 'published' => 1, 'display_orders' => 8])->first();

        //PICK OF THE WEEK
        $section_pick_of_the_week = Section::where(['section' => 'Pick of the week', 'published' => 1])->first();
        $pick_of_the_week_1 = Poster::where(['poster_type' => 'Pick of the week', 'published' => 1, 'display_orders' => 1])->first();
        $pick_of_the_week_2 = Poster::where(['poster_type' => 'Pick of the week', 'published' => 1, 'display_orders' => 2])->first();

        //DISCOUNTS OF THE WEEK
        $section_discount_of_the_week = Section::where(['section' => 'Discount of the week', 'published' => 1])->first();
        $discount_of_the_week_1 = Poster::where(['poster_type' => 'Discount of the week', 'published' => 1, 'display_orders' => 1])->first();
        $discount_of_the_week_2 = Poster::where(['poster_type' => 'Discount of the week', 'published' => 1, 'display_orders' => 2])->first();

        //TRENDING
        $section_trending = Section::where(['section' => 'Trending', 'published' => 1])->first();
        $trending_1 = Poster::where(['poster_type' => 'Trending', 'published' => 1, 'display_orders' => 1])->first();
        $trending_2 = Poster::where(['poster_type' => 'Trending', 'published' => 1, 'display_orders' => 2])->first();
        $trending_3 = Poster::where(['poster_type' => 'Trending', 'published' => 1, 'display_orders' => 3])->first();
        ...
        return view('webviews.home', compact(
            'featured_products', 
            'topRated', 
            'bestSellProduct', 
            'latest_products', 
            ...
            'pick_of_the_week_1',
            'pick_of_the_week_2',
            'discount_of_the_week_1',
            'discount_of_the_week_2',
            'trending_1',
            'trending_2',
            'trending_3',
            'newses',
            ...
            'section_cat_2',
            'section_deals',
            'section_pick_of_the_week',
            'section_discount_of_the_week',
            'section_trending',
            'section_brands',
            'section_new_arrival',
            'section_news'
    ...
    public function all_brands()
    {
        ...
        $categories = Category::where('position', 0)->priority()->take(12)->get();
        return view('web-views.brands', compact('brands', 'categories'));
    }
    ...
    public function checkout_details(Request $request)
    {
        ...
        if (count($cart_group_ids) > 0) {
            return view('web-views.checkout-shipping', compact('categories'));
    ...
    public function checkout_payment()
    {
        ...
        if (session()->has('address_id') && count($cart_group_ids) > 0) {
            $categories = Category::where('position', 0)->priority()->take(12)->get();
            return view('web-views.checkout-payment', compact('categories'));
        }
    ...
    public function checkout_complete(Request $request)
    {
        ...
        return view('web-views.checkout-complete', compact('categories'));
    }
    ...
    public function shop_cart(Request $request)
    {
        ...
        if (auth('customer')->check() && Cart::where(['customer_id' => auth('customer')->id()])->count() > 0) {
            return view('web-views.shop-cart', compact('categories'));
        }
        Toastr::info(translate('no_items_in_basket'));
        return redirect('/');
    }
    ...
    public function product($slug)
    {
        ...
        if ($product != null) {
            ...
            return view('web-views.products.details', compact('product', 'categories', 'countWishlist', 'countOrder', 'relatedProducts', 'deal_of_the_day', 'return_policy'));
        }
    ...
    public function viewWishlist()
    {
        ...
        $categories = Category::where('position', 0)->priority()->take(12)->get();
        return view('web-views.users-profile.account-wishlist', compact('wishlists','categories'));
    }
    ...
    public function privacy_policy()
    {
        ...
        return view('web-views.privacy-policy', compact('privacy_policy','categories'));
    }
