...
use App\CPU\HandleDeliveryManager;
...
class OrderController extends Controller
{
    ...
    public function status(Request $request)
    {
        ...
        if ($request->order_status == 'processing') {
            HandleDeliveryManager::create_ticket($order);
        }

        //cancel
        if ($request->order_status == 'canceled') {
            //return response()->json(HandleDeliveryManager::cancel_ticket($order->bizlog_ticket));
            HandleDeliveryManager::cancel_ticket($order->bizlog_ticket, $order);
        }

        //return response()->json(HandleDeliveryManager::create_ticket($order));
        return response()->json($request->order_status);
    }
