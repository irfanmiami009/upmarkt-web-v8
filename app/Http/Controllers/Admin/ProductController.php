...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        //$p->return_policy = $request->return_policy[array_search('en', $request->lang)];
        $p->warranty = $request->warranty[array_search('en', $request->lang)];
    ...
    public function update(Request $request, $id)
    {
        ...
        //$product->return_policy = $request->return_policy[array_search('en', $request->lang)];
        $product->warranty = $request->warranty[array_search('en', $request->lang)];
