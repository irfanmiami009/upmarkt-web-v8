                            ...
                            <div class="hs-unfold float-right col-6">
                                <div class="dropdown">
                                    <select name="order_status" onchange="order_status(this.value)"
                                        ...
                                        <option
                                            value="processing" {{$order->order_status == 'processing'?'selected':''}} >{{\App\CPU\translate('Processing')}} (Bizlog) </option>
                                        ...
                                        <option
                                            value="canceled" {{$order->order_status == 'canceled'?'selected':''}} >{{\App\CPU\translate('Canceled')}} (Bizlog)</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 pt-2">
                                <div class="text-right">
                                    ...
                                    <h6 class="" style="color: #8a8a8a;">
                                        Bizlog Ticket Number
                                        : {{$order['bizlog_ticket']}}
                                    </h6>
                                    <h6 class="" style="color: #8a8a8a;">
                                        Bizlog Ticket Status
                                        : {{$order['bizlog_ticket_status']}}
                                    </h6>
                                </div>
                            </div>
                        </div>
