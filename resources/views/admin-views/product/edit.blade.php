...
@push('css_or_js')
    ...
    <script src="{{asset('public/assets/back-end/js/tinymce.min.js')}}"></script>
@endpush
                            ...
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    <div class="form-group">
                                        <label class="input-label" for="{{$lang}}_name">{{\App\CPU\translate('name')}}</label>
                                    ...
                                    <div class="form-group pt-4">
                                        ...
                                        <textarea id="product-description" class="description" name="description[]" required>
                                            {!! $translate[$lang]['description']??$product['details'] !!}
                                        </textarea>
                                    </div>
                                    <div class="form-group pt-4">
                                        <label class="input-label">Warranty</label>
                                        <textarea class="description" name="warranty[]">{!! $translate[$lang]['warranty']??$product['warranty'] !!}</textarea>
                                    </div>
                                </div>
                            @endforeach
                        </div>
...
@push('script_2')
    ...
    <script type="text/javascript">
        tinymce.init({
          ...
          //images_upload_url: "{{route('admin.images.upload')}}",
