                                ...
                                <div class="{{$lang != $default_lang ? 'd-none':''}} lang_form"
                                    ...
                                    <div class="form-group pt-4">
                                        <label class="input-label"
                                               for="{{$lang}}_description">{{\App\CPU\translate('description')}}</label>
                                            <textarea class="description" name="description[]" required>{{old('details')}}</textarea>
                                    </div>
                                    <div class="form-group pt-4">
                                        <label class="input-label">Warranty</label>
                                        <textarea class="description" name="warranty[]" >
                                            {{old('warranty')}}
                                        </textarea>
                                    </div>
                                </div>
