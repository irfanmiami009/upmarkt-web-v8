                ...
                <div class="details">
                    ...
                    @if($product->added_by=='seller')
                        @if(isset($product->seller->shop))
                            <div>
                                <a style="text-decoration: none;" href="#" class="d-flex align-items-center">
                                    <div
                                        class="title seller-name">By {{$product->seller->shop->name}}</div>
                                </a>
                            </div>
                        @endif
                    @else
                        <div>
                            <a style="text-decoration: none;" href="#" class="d-flex align-items-center">
                                <div
                                    class="title seller-name">By {{$web_config['name']->value}}</div>
                            </a>
                        </div>
                    @endif
                    <div class="d-flex align-items-center mb-2 pro">
                        ...
                        <span
                            class="rating-text font-for-tab d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-1 ml-md-2 ml-1 pr-md-2 pr-sm-1 pl-md-2 pl-sm-1' : 'ml-1 mr-md-2 mr-1 pl-md-2 pl-sm-1 pr-md-2 pr-sm-1'}}">{{$overallRating[1]>0?$overallRating[1]:'No '}} {{\App\CPU\translate('Reviews')}}</span>
                    ...
                    <div class="mb-1">
                        ...
                        <span class="discount-percentage">
                            (<span id="set-discount-percentage"></span>)
                        </span>
                        <span id="stock_text"></span>
                    ...
                    <div class="price-info">
                        <span>Save</span>
                        <span id="set-discount-amount"></span> MRP
                        <!-- <strike id="set-discount-amount"></strike> MRP -->
                        <strike>
                            {{\App\CPU\Helpers::currency_converter($product->unit_price)}}
                        </strike>
                    ...
                    <!-- Quantity + Add to cart -->
                                ...
                                <div class="product-quantity d-flex align-items-center">
                                    <div
                                        ...
                                        <span class="input-group-btn">
                                            <button class="cart-button btn btn-number" type="button"
                                        ...
                                        <span class="input-group-btn">
                                            <button class="cart-button btn btn-number" type="button" data-type="plus"
                            ...
                            <div class="col-lg-5 col-8">
                                <div class="input-container">
                                    <div class="pincode-box">
                                        <input minlength="6" maxlength="6" placeholder="Pincode" class="delivery-pincode" type="text" >
                                    </div>
                                    <div class="pincode-button">
                                        <!-- <input class="delivery-submit" type="button"> -->
                                        <button class="delivery-submit" type="button">Apply</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div>
                                <p class="delivery_response"></p>
                            </div>
                        </div>
                        <!-- more product details -->
                        <div class="row">
                            <div>
                                <a style="text-decoration: none;color: #ff0000" href="#overview">More product details...</a>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <div class="product_overview mt-1">
                    ...
                    <ul class="nav nav-tabs d-flex" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#return-policy" data-toggle="tab" role="tab"
                               style="color: black !important;">
                                RETURN POLICY
                            </a>
                        </li>
...
@push('script')
    ...
    <script>
        ...
        $(".delivery-submit").on('click', function(e) {
            let pincode = $(".delivery-pincode").val();
            if (pincode == "") {
                $(".delivery_response").text("Invalid Pincode").css("color", "red");
                return false;
            }
            let data = {
                pincode: pincode
            ...
            $.ajax({
                ...
                success: function (response) {
                    if(response.length > 0) {
                        ...
                        var display_date = "Get it by "+ moment(date).format('ddd, MMM DD YYYY')
                        $(".delivery_response").text(display_date).css("color", "green");
                    }else{
                        $(".delivery_response").text("Sorry we do not ship to your pincode yet").css("color", "red");
                    }
                }
            });
        })
