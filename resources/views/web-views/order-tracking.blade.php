    ...
    <div class="container mb-md-3">
        ...
        <div class="card border-0 box-shadow-lg mt-5">
            <div class="card-body pb-2">
                <ul class="nav nav-tabs media-tabs nav-justified" style="border-bottom: unset !important;">
                    @if ($orderDetails['order_status']!='returned' && $orderDetails['order_status']!='failed')
                        ...
                        <li class="nav-item ">
                            <div class="nav-link ">
                                <div class="align-items-center">
                                    <div class="media-tab-media"
                                         style="margin: 0 auto; @if(($track_list[0]->bizlog_track_status == 'Processing order') || ($track_list[0]->bizlog_track_status =='Order shipped') || ($track_list[0]->bizlog_track_status=='Out for delivery')) background: #4bcc02; color: white; @endif ">
                                        @if(($track_list[0]->bizlog_track_status =='Processing order') || ($track_list[0]->bizlog_track_status =='Order shipped') || ($track_list[0]->bizlog_track_status=='Out for delivery'))
                                            <i class="czi-check"></i>
                                        @endif
                                    </div>
                                    <div class="media-body" style="text-align: center;">
                        ...
                        <li class="nav-item">
                            <div class="nav-link  ">
                                <div class="align-items-center">
                                    <div class="media-tab-media"
                                         style="margin: 0 auto; @if(($track_list[0]->bizlog_track_status=='Order shipped') || ($track_list[0]->bizlog_track_status=='Out for delivery')) background: #4bcc02; color: white; @endif ">
                                        @if(($track_list[0]->bizlog_track_status=='Order shipped') || ($track_list[0]->bizlog_track_status=='Out for delivery'))
                                            <i class="czi-check"></i>
                                        @endif
                                    </div>
                                    <div class="media-body" style="text-align: center;">
                        ...
                        <li class="nav-item">
                            <div class="nav-link ">
                                <div class="align-items-center">
                                    <div class="media-tab-media"
                                         style="margin: 0 auto; @if(($track_list[0]->bizlog_track_status=='Out for delivery')) background: #4bcc02; color: white; @endif">
                                        @if(($track_list[0]->bizlog_track_status=='Out for delivery'))
                                            <i class="czi-check"></i>
                                        @endif
                                    </div>
                                    <div class="media-body" style="text-align: center;">
                                        <!-- <div class="media-tab-subtitle text-muted font-size-xs mb-1">Fourth step</div> -->
                                        <h6 class="media-tab-title text-nowrap mb-0">Out for delivery</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
